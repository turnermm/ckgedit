...
(function() {
	var imageDialog = function( editor, dialogType ) {
			...
			var updatePreview = function( dialog ) {
              ...
              var show_obj = function(obj) {             
                    for(var i in obj) {             
                       if(obj[i] && obj[i].toString().match(/function/)) continue;     
                             msg = i + " = " + obj[i];                         
...
//show_obj(this.imageElement['$']);
					// Remove empty style attribute.
					if ( !this.imageElement.getAttribute( 'style' ) )
						this.imageElement.removeAttribute( 'style' );

				//	if ( this.imageElement.getAttribute( 'style' ) &&  linktype == 'linkonly') {
					//	this.imageElement.removeAttribute( 'style' );
                   // }

...
CKEDITOR.plugins.add( 'fontAssist',
{
	...
	init: function( editor )
	{
		...
		editor.ui.addButton( 'FontAssist',
		{
			...
			label: 'Check and Revise Font Styling',
				...
				[
					{
						...
						[
							...
							// http://docs.cksource.com/ckeditor_api/symbols/CKEDITOR.ui.dialog.html.html
							{
								...
								html : 'View and optionally alter text styled with the font plugin .'
							},
							{                            
								type : 'html',
                            ...
                            {
                               id: 'oktoggle', 
                               label: ' If checked, uncheck to activate OK button',
                               type: 'checkbox',                              
                               'default' : false,
                               onChange: function() {  
                                 var dialog = this.getDialog();                                

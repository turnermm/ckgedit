			   ...
			   var other_mime_file = "";
				switch ( data.type || 'url' )
				{
					...
					case 'internal':
                        ...
                        var ar = data.url.url.split(/;;/);
                        if(oDokuWiki_FCKEditorInstance.useheading == 'y') {
                            data.adv.advTitle = ar[1];
                        }
                        data.url.url = ar[0];
					   ...
					   if(ilinkstyle == 'page' && oDokuWiki_FCKEditorInstance.useheading == 'n') {
					...
					case 'interwiki':    
                       ...
                       iwiki_text = this.getValueOf('info', 'iwikidisp') || "";//data.url.url;                      
    ...
    insertLink: function(title){
        ...
        if(title && oDokuWiki_FCKEditorInstance.useheading == 'y') {
          dialog.getContentElement("info", "internal_text").setValue(title);
            ...
            var ltype = dialog.getValueOf( 'info', 'ilinkstyle' );
            if(ltype == 'page') {
                var link_ar = link.split(':',link); 
                link = link_ar.pop();
            }    

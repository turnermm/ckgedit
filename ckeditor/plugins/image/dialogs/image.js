 ...
 */
var ckgeditLinkTypeId,ckgeditAlignInputId;
var ckgeditDwikiSaveDir= oDokuWiki_FCKEditorInstance.save_dir;
var ckgeditImageReselectObj = { 'align': "", 'link':""};
	...
	var imageDialog = function( editor, dialogType ) {
			...
			function commitInternally( targetFields ) {
				...
				var dialog = this.getDialog(),
                 ...
                 ckgeditAlignInputId =dialog.getContentElement('info',  'cmbAlign').getInputElement().$.id;
                 ckgeditLinkTypeId =dialog.getContentElement('info',  'cmbLinkType').getInputElement().$.id;

                 if(ckgeditImageReselectObj['align']) {
                    var align_value = 0;
                     switch (ckgeditImageReselectObj['align']) {
                         case 'medialeft':
                            align_value = 1;
                            break;
                         case 'mediaright':
                     ...
                     var align_sel = document.getElementById(ckgeditAlignInputId);
                     align_sel.options[align_value].selected = true;
                     ckgeditImageReselectObj['align'] = "";
                 }
                 if(ckgeditImageReselectObj['link']) {
                     var link_value = 0;
                     switch(ckgeditImageReselectObj['link']) {
                        case 'detail':
                            link_value = 0;
                            break;
                        case 'direct':
                     ...
                     var link_sel = document.getElementById(ckgeditLinkTypeId);
                     link_sel.options[link_value].selected = true;
			...
			return {
				...
				onShow: function() {
                    ...
                    if(element && element['$']) {
                         ...
                         ckgeditImageReselectObj['align'] = className;
                         linkType = element['$'].getAttribute('type');
                         }
					...
					if ( link ) {
                        ...
                        if(linkType) {
                             ckgeditImageReselectObj['link'] = linkType;
                         }
                        else ckgeditImageReselectObj['link'] = 'nolink';
                    }

                   if(link) {
                       if(link['$']['outerHTML'].match(/detail/)) {
                             ckgeditImageReselectObj['link'] = 'detail';
                        }
                         else {
                              ckgeditImageReselectObj['link'] = 'direct';
                         }
                    }
				...
				onOk: function() {
					...
					} else // Create a new image.
					{
                     ...
                     var link_sel = document.getElementById(ckgeditLinkTypeId);
                     var linktype = 'detail';
                     if(link_sel.selectedIndex > 0) {
                         var linktype =  link_sel.options[link_sel.selectedIndex].value;
                     }
                     this.imageElement.setAttribute( 'type', linktype );
					// Create a new link.
					...
					this.commitContent( IMAGE, this.imageElement );
                                         ...
                                         var align_sel = document.getElementById(ckgeditAlignInputId);
                     if(align_sel.selectedIndex > 0) {
                         var img_alignment =  align_sel.options[align_sel.selectedIndex].value;
                         this.imageElement.setAttribute( 'class', img_alignment );
                     }
                     else this.imageElement.setAttribute( 'class', 'media' );
					...
					elements: [
						...
						children: [
								...
								children: [
									{
                                        id: 'cmbLinkType',
                                        type: 'select',
                                        label: editor.lang.common.linkType||"Link Type",
                                        'default': 'detail',
                                        items: [
                                            [ editor.lang.common.linkDetail  || "Detail", 'detail'],
                                            [ editor.lang.common.linkDirect ||"Direct", 'direct' ],
                                            [ editor.lang.common.linkNoLink || "No Link" , 'nolink'],
                                            [ editor.lang.common.linkOnly || "Link only" , 'linkonly'],
                                        ],
							    },
                                {
                                   type: "html",
                                   html: "<p>&nbsp;</p>",
									...
									items: [
										...
										[ editor.lang.common.alignLeft, 'medialeft' ],
										[ editor.lang.common.alignRight, 'mediaright' ],
                                        [editor.lang.common.alignCenter , 'mediacenter'],
                                        [ editor.lang.common.alignBaseLine||"Baseline" , 'baseline'],
									],
                                    									onChange: function() {
										updatePreview( this.getDialog() );
										commitInternally.call( this, 'advanced:txtdlgGenStyle' );
											...
											if ( value ) {
                                                ...
                                                switch(value) {
                                                    case 'center':
                                                       ...
                                                       element.setAttribute( 'class', 'mediacenter');
                                                       break;
                                                    case 'baseline':
                                                       value = 'left';
                                                    default:
							...
							children: [
								...
								id: 'htmlPreview',
								style: 'width:95%;',
								html: '<style type = "text/css">.mediacenter { display: block; margin-left: auto; margin-right: auto;}</style><div>' + CKEDITOR.tools.htmlEncode( editor.lang.common.preview ) + '<br>' +
					...
					elements: [
						...
						setup: function( type, element ) {
							if ( type == LINK ) {
                                ...
                                var matches = href.match(/media\s*=(.*)/);
                                if(matches) {
                                    href = ckgeditDwikiSaveDir + '/'+  matches[1].replace(':','/');

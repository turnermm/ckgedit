    ...
    function fckg_edit_meta(&$event)
    {
        ...
        $event->data['script'][] = 
            array( 
                ...
                'charset'=>'utf-8', 
                '_data'=>'',
                 'src'=>DOKU_BASE.'lib/plugins/fckg/' .$this->fck_location. '/ckeditor.js'
            );
return;
        $event->data['script'][] = 
            array( 
...
$ckeditor_replace =<<<CKEDITOR_REPLACE
		   ...
		   fckgCKInstance = CKEDITOR.replace('wiki__text',
		       { 
                  toolbar: '$toolbar' ,    
                  filebrowserImageBrowseUrl :  '$doku_url/lib/plugins/fckg/fckeditor/editor/filemanager/browser/default/browser.html?Type=Image&Connector=$doku_url/lib/plugins/fckg/fckeditor/editor/filemanager/connectors/php/connector.php?' ,
                  filebrowserBrowseUrl: '$doku_url/lib/plugins/fckg/fckeditor/editor/filemanager/browser/default/browser.html?Type=File&Connector=$doku_url/lib/plugins/fckg/fckeditor/editor/filemanager/connectors/php/connector.php?',                                
               }
		   );
           FCKeditor_OnComplete(fckgCKInstance);

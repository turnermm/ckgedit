 ...
 */
var fckgLinkTypeId,fckgAlignInputId;
var fckgDwikiSaveDir= oDokuWiki_FCKEditorInstance.save_dir;
var fckgImageReselectObj = { 'align': "", 'link':""};
	...
	var imageDialog = function( editor, dialogType ) {
			...
			function commitInternally( targetFields ) {
				...
				var dialog = this.getDialog(),
                 ...
                 fckgAlignInputId =dialog.getContentElement('info',  'cmbAlign').getInputElement().$.id;  
                 fckgLinkTypeId =dialog.getContentElement('info',  'cmbLinkType').getInputElement().$.id;         
                 
                 if(fckgImageReselectObj['align']) {                     
                    var align_value = 0;
                     switch (fckgImageReselectObj['align']) {
                         case 'medialeft':
                            align_value = 1;
                            break;
                         case 'mediaright':
                     ...
                     var align_sel = document.getElementById(fckgAlignInputId); 
                     align_sel.options[align_value].selected = true;                         
                     fckgImageReselectObj['align'] = "";                    
                 }
                 if(fckgImageReselectObj['link']) {                   
                     var link_value = 0;
                     switch(fckgImageReselectObj['link']) {
                        case 'detail':
                            link_value = 0;
                            break;                        
                        case 'direct':
			...
			return {
				...
				onShow: function() {
                    ...
                    if(element && element['$']) {
                         ...
                         fckgImageReselectObj['align'] = className;
				...
				//Hide loader.
					...
					if ( link ) {
                        ...
                        if(linkType) {
                             fckgImageReselectObj['link'] = linkType;
                         }
                        else fckgImageReselectObj['link'] = 'nolink';
                    }   
                       
                   if(link) {
                       if(link['$']['outerHTML'].match(/detail/)) {
                             fckgImageReselectObj['link'] = 'detail';
                        }
                         else {
                              fckgImageReselectObj['link'] = 'direct';
                         }
                    }   
					...
					elements: [
						...
						setup: function( type, element ) {
							if ( type == LINK ) {
                                ...
                                if(matches) {                              
                                    href = fckgDwikiSaveDir + '/'+  matches[1].replace(':','/'); 

...
$lang['dwedit_ns'] = "Comma gescheiden lijst van namespaces waarbij ckgedit automatisch terugschakelt" .
...
$lang['nix_style'] = "Voor Windows Servers (Vista en later).  Deze parameter maakt het mogelijk om data\\media te benaderen met ckgedit\\fckeditor\\userfiles, indien links naar media en bestand succesvol aangemaakt zijn in userfiles";
$lang['no_symlinks']  = "Desactiveer automatische creatie van symbolische links in ckgedit/userfiles.";
$lang['direction'] = 'Zet de schrijf en lees richting van de taal in FCKeditor:  <b>nocheck</b>: geen wijziging van de verstekwaarde in ckgedit; '

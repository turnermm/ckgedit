...
$lang['dw_priority']           = 'Den Dokuwiki-Editor als Standard-Editor verwenden (funktioniert nicht in Wiki Farms)';
...
$lang['extra_plugins']         = 'Komma-getrennte Liste von zusätzlichen Ckeditor plugins die zur Werkzeugleiste hinzugefügt werden sollen. Siehe <a href=\'https://www.dokuwiki.org/plugin:ckgedit:configuration#extra_plugins\'>ckgedit Konfiguration</a> für weitere Einzelheiten';
$lang['dw_users']              = 'Gruppenname der User die den Dokuwiki-Editor als Standard-Editor eingestellt bekommen, wenn <b>dw_priority</b> ausgewählt ist. Wenn diese Gruppe nicht definiert ist und <b>dw_priority</b ausgewählt wid, bekommen alle User den ursprünglichen Dokuwiki-Editor.';
$lang['allow_ckg_filebrowser'] = 'Wählen Sie, welchen Datei/Media-Browser die Benutzer verwenden können';
$lang['default_ckg_filebrowser'] = 'Wählen Sie, welcher Datei/Media-Browser der Standard ist. Diese Einstellung wird nicht berücksichtigt, wenn der ausgewählte Datei/Media-Browser nicht erlaubt ist';
$lang['captcha_auth']          = 'Zugriffskontroll-Ebene, bei welcher das Captcha ausgeschaltet wird wenn beim Captcha-Plugin die Option <code>forusers</code> gesetzt ist. Die Standard-Einstellung ist <code>ACL_CREATE</code> - dass heißt jedem User mit <code>ACL_EDIT</code> oder niedriger wird das Captcha angezeigt, Benutzern mit <code>ACL_CREATE</code> oder höher wird das Captcha nicht angezeigt.';

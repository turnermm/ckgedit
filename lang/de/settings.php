...
$lang['extra_plugins']         = 'Durch Komma getrennte Liste zusätzlicher Ckeditor-Plugins, die der Symbolleiste hinzugefügt werden sollen. Einzelheiten sind auf der <a href=\'https://www.dokuwiki.org/plugin:ckgedit:configuration#extra_plugins\'>Konfigurationsseite</a> des ckgedit-Plugins zu finden';
$lang['dw_users']              = 'Gruppenname von Benutzern, deren Editor standardmäßig der Dokuwiki-Editor ist, wenn <b>dw_priority</b> ausgewählt ist. Wenn nichts definiert ist, erhalten alle Benutzer den nativen Dokuwiki-Editor, wenn <b>dw_priority</b> ausgewählt ist.';
$lang['allow_ckg_filebrowser'] = 'Wähle aus, welcher Datei-/Medienbrowser die Benutzer verwenden können';
$lang['default_ckg_filebrowser'] = 'Wählen aus, welcher Datei-/Medienbrowser der Standard ist. Diese wird ignoriert, wenn der ausgewählte Browser nicht zugelassen ist';
$lang['captcha_auth']          = 'ACL-Ebene, auf der das Captcha deaktiviert wird, wenn die Option <code>forusers</code> des Captcha-Plugins auf „true“ gesetzt ist. Der Standardwert ist <code>ACL_CREATE</code>, was bedeutet, dass jeder Benutzer mit <code>ACL_EDIT</code> oder weniger das Captcha erhält, <code>ACL_CREATE</code> oder höher nicht.';

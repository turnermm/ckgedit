 ...
 *
 * @author Florian Aigner <info@faigner.de>
...
$lang['allow_ckg_filebrowser'] = 'Auswählen welche Datei/Medien Browser von den Nutzern genutzt werden können';
$lang['default_ckg_filebrowser'] = 'Auswählen welcher Datei/Medienbrowser standardmäßig verwendet wird. Dies wird überschrieben falls der ausgewählte Browser nicht erlaubt ist.';
$lang['captcha_auth']          = 'ACL Level ab dem das captcha abgeschalten wird, wenn das Plugin die <code>forusers</code> Option gesetzt hat. Standardmäßig ist  <code>ACL_CREATE</code> gesetzt was bedeutet dass jeder Nutzer mit <code>ACL_EDIT</code> oder niedriger ein captcha lösen muss, aber Nutzer mit <code>ACL_CREATE</code> oder höher nicht.';

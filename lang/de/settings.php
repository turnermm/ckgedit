 ...
 *
 * @author Ben_2003 <dsoeteber@web.de>
...
$lang['extra_plugins']         = 'Durch Komma getrennte Liste zus&auml;tzlicher Ckeditor-Plugins, die der Symbolleiste hinzugef&uuml;gt werden sollen. Einzelheiten findest Du auf der <a href=\'https://www.dokuwiki.org/plugin:ckgedit:configuration#extra_plugins\'>Konfigurationsseite</a> des ckgedit-Plugins';
$lang['dw_users']              = 'Gruppenname von Benutzern, deren Editor standardm&auml;ßig der Dokuwiki-Editor ist, wenn <b>dw_priority</b> ausgew&auml;hlt ist. Wenn nichts definiert ist, erhalten alle Benutzer den nativen Dokuwiki-Editor, wenn <b>dw_priority</b> ausgew&auml;hlt ist.';
$lang['allow_ckg_filebrowser'] = 'W&auml;hle aus, welchen Datei-/Medienbrowser Benutzer verwenden können';
$lang['default_ckg_filebrowser'] = 'W&auml;hle aus, welcher Datei-/Medienbrowser der Standard ist. Diese Einstellung wird ignoriert, wenn der ausgew&auml;hlte Browser nicht zugelassen ist';
$lang['captcha_auth']          = 'ACL-Ebene, auf der das Captcha deaktiviert wird, wenn die Option <code>forusers</code> des Captcha-Plugins auf „true“ gesetzt ist. Der Standardwert ist <code>ACL_CREATE</code>, was bedeutet, dass jeder Benutzer mit <code>ACL_EDIT</code> oder weniger das Captcha erh&auml;lt, <code>ACL_CREATE</code> oder höher nicht.';

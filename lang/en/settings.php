...
$lang['scayt_auto'] = 'Automatically enable the SCAYT spellchecker on startup. Defaults to <code>off</code>: ' .
            'the scayt icon and menu remain in the editor giving limited spell-checking service with an option to re-enable the full service for the current session. (See the: <a href="https://www.dokuwiki.org/plugin:ckgedit:configuration#scayt_auto".> scayt_auto configuration option at dokuwiki.org</a>) ' .
           ' To remove Scayt and spell-checking completely, select <code>disable</code>.';

...
$lang['js']['stylesheet_oinfo'] = 'Инфо';
$lang['js']['stylesheet_cinfo'] = 'Закрыть инфо';
$lang['js']['lock_msg']        = 'Срок действия вашей блокировки на редактирование этой страницы истекает через одну минуту';
$lang['js']['willexpire']      = 'Ваша блокировка на редактирование этой страницы истекает через минуту.\nЧтобы избежать конфликтов, используйте кнопку резервного копирования, чтобы сбросить таймер блокировки.';
...
$lang['menu']                  = 'Инструмент CSS редактора CKEditor';
$lang['default_stylesheet']    = 'Создайте таблицу стилей для текущего шаблона';
$lang['alt_stylesheet']        = 'Создайте таблицу стилей для другого шаблона';
$lang['style_sheet']           = 'Создать таблицу стилей';
$lang['style_sheet_msg']       = 'Создание таблицы стилей для текущего шаблона:';
$lang['alt_style_sheet_msg']   = 'Создание таблицы стилей для:';
$lang['checkbox']              = 'Скопируйте в ckeditor/css';
$lang['stylesheet_oinfo']      = 'Инфо';
$lang['stylesheet_cinfo']      = 'Закрыть инфо';
$lang['list_in_table']         = 'DokuWiki не поддерживает списки в таблицах. Разметка списка была удалена, но содержимое сохранено.';

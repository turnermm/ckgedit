...
$lang['title_dw_edit']         = '内容を保存して編集を終わり、DokuWiki組み込みのエディタに切り替える';
...
$lang['js']['on']              = 'ON';
$lang['js']['off']             = 'OFF';
$lang['js']['broken_image_1']  = 'DokuWikiメディアマネージャーとimagePasteプラグインを併用するか、Microsoft Wordの貼り付けのオプションをお試し下さい。';
$lang['js']['broken_image_2']  = 'Ctrl+Vキーで画像を貼り付ける際、生データが2.5Mより大きい場合はハングする可能性があります。この画像のサイズ：';
...
$lang['ckg_img_paste']         = '補助画像貼り付けサポートを有効にする';
$lang['ckg_img_paste_title']   = '二重ペーストを避ける場合はOFFに、貼り付けを有効にするにはONにします';
$lang['on']                    = 'ON';
$lang['off']                   = 'OFF';
$lang['broken_image']          = 'DokuWikiメディアマネージャーとimagePasteプラグインを併用するか、Microsoft Wordの貼り付けのオプションをお試し下さい。Ctrl+Vキーで画像を貼り付ける際、生データが2.5Mより大きい場合はハングする可能性があります。この画像のサイズ：';
